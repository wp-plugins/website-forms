...
/**
* Wishpond can make 5 different types of requests to wordpress:
 1) endpoint: publish_campaign => not used by this plugin
...
var wishpond_api = {
  ...
  message: {
    ...
    display: function(message_type, message_text) {
      ...
      jQuery("#wishpond_iframe").before("<div id=" + this.id + " class='" + message_type + "'><p>" + message_text + "</p></div>");
