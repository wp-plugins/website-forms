<?php
  ...
  */
  function wishpond_auth_url_with_token( $redirect_to = "" )
  {
    ...
    $url = add_url_param( $url, "utm_medium", "Website Forms");
    $url = add_url_param( $url, "referral", "wp_forms");
  ...
  */
  function wishpond_auth_url_with_guest_user( $redirect_to_string = "")
  {
    ...
    $redirect_to->add_param( "utm_medium", "Website Forms" );
    ...
    $url->add_param( "utm_medium", "Website Forms" );
    $url->add_param( "referral", "wp_forms" );
