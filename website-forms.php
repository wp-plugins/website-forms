<?php
   ...
   * Plugin URI: http://corp.wishpond.com/online-forms/
  ...
  */
  ...
  if ( ! defined( 'WISHPOND_WEBSITE_FORMS_PREFIX' ) ) {
    define( 'WISHPOND_WEBSITE_FORMS_PREFIX' , 'WISHPOND_WEBSITE_FORMS' );
  }
